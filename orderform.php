...
function activatepl()
	...
	$tablename= $wpdb->prefix."orders";
		if($wpdb->get_var("show tables like '$tablename'")!=$tablename)
		{
			  ...
			  `Organizationfull` varchar(512) COLLATE utf8_bin NOT NULL,
			  `Organizationshort` varchar(512) COLLATE utf8_bin NOT NULL,
			  `FIOdir` varchar(50) COLLATE utf8_bin NOT NULL,
			  `Positiondir` varchar(100) COLLATE utf8_bin NOT NULL,
			  `Reasondir` varchar(50) COLLATE utf8_bin NOT NULL,
			  `Phonedir` varchar(50) COLLATE utf8_bin NOT NULL,
			  `FIOcont` varchar(50) COLLATE utf8_bin NOT NULL,
			  `Positioncont` varchar(100) COLLATE utf8_bin NOT NULL,
			  `Phonecont` varchar(50) COLLATE utf8_bin NOT NULL,
			  `Email` varchar(50) COLLATE utf8_bin NOT NULL,
			  `INN` varchar(12) COLLATE utf8_bin NOT NULL,
			  `KPP` varchar(9) COLLATE utf8_bin NOT NULL,
			  `OGRN` varchar(14) COLLATE utf8_bin NOT NULL,
			  `Schet` varchar(20) COLLATE utf8_bin NOT NULL,
			  `Korrschet` varchar(20) COLLATE utf8_bin NOT NULL,
			  `BIK` varchar(9) COLLATE utf8_bin NOT NULL,
			  `Bankname` varchar(512) COLLATE utf8_bin NOT NULL,
			  `Addrlegal` varchar(512) COLLATE utf8_bin NOT NULL,
			  `Addrfact` varchar(512) COLLATE utf8_bin NOT NULL,
